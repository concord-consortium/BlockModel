...
public static native int random(int seed);
...
public static native void debug(String s, int wait);
...
public static native void setTrace(boolean on, int delay, int minY, int lines);

/** copies the specific string to the clipboard */
public static native void clipboardCopy(String s);
/** gets the last string from the clipboard. if none, returns "". */
public static native String clipboardPaste();
}