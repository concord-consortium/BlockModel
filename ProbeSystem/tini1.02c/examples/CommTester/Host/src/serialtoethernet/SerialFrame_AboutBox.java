...
public class SerialFrame_AboutBox extends JDialog implements ActionListener
{
  ...
  String product = "SerialToEthernet";
  String version = "1.0";
  String copyright = "Copyright (c) cw";
  String comments = "";
  public SerialFrame_AboutBox(Frame parent)
  {
    super(parent);
