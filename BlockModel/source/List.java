...
public class List extends Window
{
  ...
  public void setSelectedIndex(int i)
  {
    if (-1 <= i && i < options.getCount()) //guich
    {
      ...
      //if (parent instanceof RelativeContainer) - guich
  ...
  public void onPaint(Graphics g)
  {
    ...
    if (popup==null)
    {
      ...
      g.drawLine(3,3,4,3);
      g.translate(0,-4);
      g.drawText(getSelected(),10,0); //guich
    }
    else
    {
      drawList(g);
  ...
  public void onEvent(Event event)
  {
    ...
    {
	// I don't think this can happen we'll have to hack this
      if (popup!=null)
      {
	  unpop();
	  popup=null;
    ...
    if (event instanceof PenEvent)
    {
      ...
      switch (event.type)
      {
	    ...
	    height = textHeight*numDisplayed+3;
